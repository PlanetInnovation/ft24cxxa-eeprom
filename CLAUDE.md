...
**Ft24cxxa** - MicroPython driver for FT24CxxA I2C EEPROM family (1KB-8KB)
...
### Single File Library
- `micropython_ft24cxxa.py` - Main library implementation


### Supporting Files
- `test/test_micropython_ft24cxxa.py` - Unit tests with MicroPython mocking
